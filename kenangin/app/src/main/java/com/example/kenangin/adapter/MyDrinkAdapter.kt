package com.example.kenangin.adapter
...
class MyDrinkAdapter (
    ...
    private val list:List<DrinkModel>,
                private val cartListener: ICartLoadListerner
