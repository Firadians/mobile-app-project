...
class homeFragment : AppCompatActivity(), IDrinkLoadListener, ICartLoadListerner {
...
//        btnCart.setOnClickListener{startActivity(Intent(this,cartFragment::class.java))}
    }
